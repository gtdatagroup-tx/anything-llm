...
export default function DrupalWikiOptions() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      showToast(
        "Fetching all pages for the given  DrupalWiki spaces - this may take a while.",
        "info",
        {
          clear: true,
          autoClose: false,
      ...
      showToast(
        `Pages collected from DrupalWiki spaces ${data.spaceIds}. Output folder is ${data.destination}.`,
        "success",
        { clear: true }
      );
      e.target.reset();
          ...
          <div className="w-full flex flex-col py-2">
            <div className="w-full flex flex-col gap-4">
              <div className="flex flex-col pr-10">
                <div className="flex flex-col gap-y-1 mb-4">
                  <label className="text-white text-sm font-bold flex gap-x-2 items-center">
                    <p className="font-bold text-white">DrupalWiki base URL</p>
                  </label>
              ...
              <div className="flex flex-col pr-10">
                <div className="flex flex-col gap-y-1 mb-4">
                  <label className="text-white text-sm font-bold">
                    DrupalWiki space ids
                  </label>
                  <p className="text-xs font-normal text-theme-text-secondary">
                    Comma seperated Space IDs you want to extract. Navigate to
                    the space list app and click on the space you want to use,
                    copy the ID from the url <code>/space/123</code>. Be sure
                    that your 'API-Token User' has access to those spaces.
                  </p>
                </div>
                <input
                  type="text"
              ...
              <div className="flex flex-col pr-10">
                <div className="flex flex-col gap-y-1 mb-4">
                  <label className="text-white text-sm font-bold flex gap-x-2 items-center">
                    <p className="font-bold text-white">DrupalWiki API Token</p>
                    <Warning
                      size={14}
